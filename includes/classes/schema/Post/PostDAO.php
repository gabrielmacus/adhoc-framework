...
(SELECT ao.*,count(ao.objeto_id) as 'total_archivos' FROM `archivos_objetos` ao LEFT JOIN archivos a ON a.archivo_id= ao.archivo_id {$archivosWhere}) as archivos_filter 
