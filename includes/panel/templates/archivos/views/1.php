            ...
            switch ($k)
            {
                case 0://Estandar
                    ...
                    <div class="file-preview s12 m4 l3">
                        <input data-url="<?Php echo $version->getRealName();?>" data-name="<?php echo $version->getName()?>" data-id="<?php echo $version->getId()?>" style="position: absolute;top: 20px;left: 20px;-webkit-transform: scale(1.7);-moz-transform: scale(1.7);-ms-transform: scale(1.7);-o-transform: scale(1.7);transform: scale(1.7);" type="checkbox">
                ...
                case 2://Video
                    ...
                    ?>
                    <div class="file-preview s12 m4 l3">
                        <input data-url="<?Php echo $version->getRealName();?>" data-id="<?php echo $version->getId()?>" data-name="<?php echo $version->getName()?>" style="position: absolute;top: 20px;left: 20px;-webkit-transform: scale(1.7);-moz-transform: scale(1.7);-ms-transform: scale(1.7);-o-transform: scale(1.7);transform: scale(1.7);" type="checkbox">
                        <!-- data-ng-if="p.type=='jpg' || p.type=='jpeg' ||p.type=='gif' ||p.type=='jpg' ||p.type=='png'"-->
                        <div  class="file">
