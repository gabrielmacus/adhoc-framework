                ...
                case 5:
                    ...
                    <div class="file-preview s12 m4 l3">
                        ...
                        <div  class="file">
                            ...
                            <figure style=" text-align: center;padding-top: 11%;background-position: center;background-image: url('<?php echo $version->getPath();?>');background-repeat: no-repeat;-webkit-background-size: ;background-size: cover;">
