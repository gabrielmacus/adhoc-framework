...
<div class="fila adjuntos">
    ...
    <div class="s12 m6 l4 adjunto-wrapper" style="position: relative" data-ng-repeat="a in post.anexos" data-ng-if="a.grupo==<?php echo $grupo;?>" data-ng-hide="a.delete">
        ...
        <div class="adjunto">
            <span class="name" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis">{{a.<?php echo $anexoTitle;?>}}</span>
        </div>

    </div>
    <div class="fila">
        <a  data-lity  style="display: block;color: white!important;;" class="fila btn" href="<?php echo $configuracion->getSiteAddress()?>/admin/posts/?modal=true&grupo=<?php echo $grupo?>&t=<?php echo $tipo?>&s=<?php echo $s?>">Adjuntar archivo</a>
    </div>
