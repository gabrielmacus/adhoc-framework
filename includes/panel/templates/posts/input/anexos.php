...
<div class="fila adjuntos">
    ...
    <a href="<?php echo $configuracion->getSiteAddress()?>/admin/posts/?modal=true&grupo=<?php echo $grupo?>&t=<?php echo $tipo?>&s=<?php echo $s?>&act=view&id={{a.post_id}}" class="s12 m6 l4 adjunto-wrapper" style="position: relative" data-ng-repeat="a in post.anexos" data-ng-if="a.post_nexo_grupo==<?php echo $grupo;?>" data-ng-hide="a.delete">
