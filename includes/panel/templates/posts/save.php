<script>
    ...
    angular.element(function () {
        ...
        $.each(scope.post.archivos,function (tipo,versiones) {
            ...
            archivos.push({id:versiones["<?php echo $fileVersion?>"].id,url:versiones["<?php echo $fileVersion?>"].realName,name:versiones["<?php echo $fileVersion?>"].name,archivo_grupo:versiones["<?php echo $fileVersion?>"].grupo});
