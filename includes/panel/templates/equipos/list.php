...
<div class="table-container">
    <table class="rwd-table">
        ...
        foreach ($posts as $post)
        {
            ...
            ?>
            <tr>
                <td data-th="Nombre"><a ><?php  echo $post->getTitulo()?></a></td>
                 <td data-th="Bandera"><a data-lity href="<?php echo $foto->getRealName()?>"><i class="fa fa-picture-o" aria-hidden="true"></i></a></td>
